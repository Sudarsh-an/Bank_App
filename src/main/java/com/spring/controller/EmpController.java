...
public class EmpController {
	...
	public String validUser(@ModelAttribute("client") Client client,Model m) {
		try {
...
//	public String depositAmount(@ModelAttribute("account") Account account, Model model) {
//	    try {
//	        // Convert the amount string to a double
//	       int amount = account.getBalance();
//	        
//	        // Here, 'amount' is now a double containing the value from the form field named "amount"
//	        // You can perform your deposit logic here, such as updating a database or processing a transaction
//	        
//	        // For this example, let's just print the amount to the console
//	        System.out.println("Deposit amount: " + amount);
...
//	        
//	        // Return the name of the view to render after processing the deposit
//	        return null; // Assuming you have a success.jsp or success.html page
//	    } catch (NumberFormatException e) {
//	        // Handle the case where the input value is not a valid number
//	        System.err.println("Invalid amount format: " + account.getBalance());
...
//	    }
//	}
	//@RequestParam("balance") String balance, @RequestParam("account_id") String account_id, Model model
	...
	// @PathVariable("balance") String balance, @PathVariable("account_id") String account_id, Model model
